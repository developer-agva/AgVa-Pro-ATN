...
public class RaspiParser extends ParserUtils
{
    ...
    public static final String DATA_RESISTANCE = "Resistance";
    ...
    private Map<String, Map<String, String>> dataMap;{
        ...
        dataMap.put(TYPE_END_OF_EXHALATION, getConfigMap(DATA_PEEP, DATA_RR, DATA_FIO2, DATA_VPEAK_E, DATA_MVE, DATA_LEAK, DATA_MEAN_AIRWAY_PRESSURE, DATA_VTE,DATA_EXPIRE_TIME, DATA_VTI,DATA_RSBI,DATA_RESISTANCE));
