...
class DataFromDataBaseAdapter(private var dataList: ArrayList<String>) :
    RecyclerView.Adapter<DataFromDataBaseAdapter.DFDViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DFDViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.parameter_units_itemtwo, parent, false)
    ...
    override fun onBindViewHolder(holder: DFDViewHolder, position: Int) {
        ...
        if (dataStore.split(",")[1] == "NA") {
            ...
            holder.tv_rr?.text = "-"
            holder.tv_ie?.text = "-"
            holder.tv_tinsp?.text = "-"
            holder.tv_texp?.text = "-"
            holder.tv_leak?.text = "-"
            holder.tv_spo2?.text = "-"
            holder.tv_pr?.text = "-"
            holder.tv_dynamic_compliance?.text = "-"
            holder.tv_spont_rr?.text = "-"
            holder.tv_spont_vt?.text = "-"
        } else {
            ...
            try {
                ...
                holder.tv_dynamic_compliance?.text = "0.0"
                holder.tv_spont_rr?.text = "0.0"
                holder.tv_spont_vt?.text = "0.0"
            }
        }
    }
