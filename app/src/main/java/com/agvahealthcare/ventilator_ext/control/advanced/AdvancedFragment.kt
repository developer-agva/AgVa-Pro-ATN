...
class AdvancedFragment(
    ...
    private var controlParamClickListener: ControlParameterClickListener? = null
    ...
    override fun notifyItemChangedAdapter(position: Int) =
        controlParamsAdapter?.notifyItemChanged(position)
